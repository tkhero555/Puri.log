class UsersController < ApplicationController
  ...
  def show
    ...
    # 食事の記録回数グラフ用のインスタンス変数
    @eating_count_graph = current_user.set_instance_eating_count_graph
    @eating_weekly_count_graph = current_user.set_instance_eating_weekly_count_graph
    @eating_daily_count_graph = current_user.set_instance_eating_daily_count_graph

    # 排便の記録回数グラフ用のインスタンス変数
    @stool_count_graph = current_user.set_instance_stool_count_graph
    @stool_weekly_count_graph = current_user.set_instance_stool_weekly_count_graph
    @stool_daily_count_graph = current_user.set_instance_stool_daily_count_graph
    ...
    @stool_this_month_condition_count = current_user.set_instance_stool_this_month_condition_count_graph
    @stool_last_month_condition_count = current_user.set_instance_stool_last_month_condition_count_graph

    # 胃腸の状態推移グラフ用のインスタンス変数
    @user_condition_graph = current_user.set_instance_user_condition_graph
